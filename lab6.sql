...
--Question 5--
select c.name , coalesce(o.cid), count(*) as "Total Ordered"
from Customers c,
	Orders o
where c.cid = o.cid 
group by c.name, o.cid
Order by c.name ASC

--Question 6--
select c.name, p.name,a.name,a.city
from Customers c,
	Orders o,
	Agents a,
	Products p
...
INNER JOIN Products p
on p.pid = o.pid
where o.dollars != ( p.priceusd * o.qty * ((100 - c.discount) / 100)) AND
